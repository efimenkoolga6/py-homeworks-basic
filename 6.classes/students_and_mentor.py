...
best_lecturer_1 = Lecturer('Ivan', 'Oblyakov')
best_lecturer_1.courses_attached += ['Python']

best_lecturer_2 = Lecturer('Fedor', 'Chalov')
best_lecturer_2.courses_attached += ['Git']

best_lecturer_3 = Lecturer('Igor', 'Akinfeev')
best_lecturer_3.courses_attached += ['Python']

cool_reviewer_1 = Reviewer('Mikhail', 'Mishustin')
cool_reviewer_1.courses_attached += ['Python']
cool_reviewer_1.courses_attached += ['Git']

cool_reviewer_2 = Reviewer('Vladimir', 'Putin')
cool_reviewer_2.courses_attached += ['Python']
cool_reviewer_2.courses_attached += ['Git']

student_1 = Student('Viktor', 'Gavrilov')
student_1.courses_in_progress += ['Python']
student_1.finished_courses += ['Введение в программирование']

student_2 = Student('Sergey', 'Ageev')
student_2.courses_in_progress += ['Git']
student_2.finished_courses += ['Введение в программирование']

student_3 = Student('Aleksey', 'Novojilov')
